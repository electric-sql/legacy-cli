defmodule ElectricCli.Command.MigrationsTest do
  ...
  describe "run commands" do
    ...
    test "build migrations", %{config: config, sql_paths: sql_file_paths} do
      ...
      capture_io(fn ->
        assert {:success, _msg} =
                 ElectricCli.Commands.Migrations.build(%{
                   args: [],
                   flags: [],
    ...
    test "sync migrations", %{config: config, sql_paths: sql_file_paths} do
      ...
      capture_io(fn ->
        assert {:success, msg} =
                 ElectricCli.Commands.Migrations.sync(%{
                   args: %{},
                   flags: [],
    ...
    test "new migrations", %{config: config, sql_paths: sql_file_paths} do
      ...
      capture_io(fn ->
        {:success, msg} =
          ElectricCli.Commands.Migrations.new(%{
    ...
    test "list migrations", %{config: config, sql_paths: sql_file_paths} do
      ...
      capture_io(fn ->
        {:success, msg} =
          ElectricCli.Commands.Migrations.list(%{
            args: %{},
            flags: [],
            options: %{root: config.root},
            unknown: nil
    ...
    test "revert migrations", %{config: config} do
      ...
      capture_io(fn ->
        {:error, msg} =
          ElectricCli.Commands.Migrations.revert(%{
