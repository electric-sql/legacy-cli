defmodule ElectricMigrations.Sqlite.Triggers do
  ...
  """
  @spec add_triggers_to_last_migration([ElectricMigrations.raw_migration(), ...], Macro.t()) ::
          {:error, [String.t()]} | {String.t(), [String.t()] | nil}
  def add_triggers_to_last_migration([_ | _] = migration_set, template) do
    migrations =
